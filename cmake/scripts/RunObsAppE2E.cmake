...
set(VERIFY_REMUX_TIMELINE OFF CACHE BOOL "Stream-copy RGB and alpha to MP4 and verify identical video timelines")
...
if(VERIFY_REMUX_TIMELINE)
    list(APPEND args "--verify-remux-timeline")
endif()
